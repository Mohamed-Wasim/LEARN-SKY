          ...
          <Form noValidate onSubmit={oStudentRegisterFormik.handleSubmit}>
            <div className="from-view_container ">
              <Row className="m-0 mb-5">
                <Col sm={12} md={10} lg={10} className="p-0 pe-2">
                  <LskyFormField
                    ...
                    errors={oStudentRegisterFormik.errors.name}
                    value={oStudentRegisterFormik.values.name}
                    touched={oStudentRegisterFormik.touched.name}
                    isRequired={true}
                  />
                </Col>
              </Row>
              ...
              <Row className="m-0 mb-5">
                <Col sm={12} md={10} lg={10} className="p-0 pe-2">
                  <LskyFormField
                    labelKey="I_UNDERSTOOD_THE_TERMS_AND_POLICY"
                    size="sm"
                    fieldName="terms"
                    className="mb-3"
                    field="check"
                    handleChange={oStudentRegisterFormik.handleChange}
                    handleBlur={oStudentRegisterFormik.handleBlur}
                    checked={oStudentRegisterFormik.values.terms}
                    errors={oStudentRegisterFormik.errors.terms}
                    value={oStudentRegisterFormik.values.terms}
                    touched={oStudentRegisterFormik.touched.terms}
                    isRequired={true}
                  />
                </Col>
              </Row>
