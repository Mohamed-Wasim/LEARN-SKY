...
!(function (t, e) { typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = e() : typeof define === 'function' && define.amd ? define(e) : (t = typeof globalThis !== 'undefined' ? globalThis : t || self).bootstrap = e() }(this, () => {
  const t = {
    ...
    return e === 'viewport'
      ...
      : ft(e)
        ? (function (t) { const e = _t(t); return e.top += t.clientTop, e.left += t.clientLeft, e.bottom = e.top + t.clientHeight, e.right = e.left + t.clientWidth, e.width = t.clientWidth, e.height = t.clientHeight, e.x = e.left, e.y = e.top, e }(e))
        : Kt(function (t) {
    ...
    fn (t) {
      const e = t.state; const i = t.options; const n = t.name; if (!e.modifiersData[n]._skip) {
        for (var s = i.mainAxis, o = void 0 === s || s, r = i.altAxis, a = void 0 === r || r, l = i.fallbackPlacements, c = i.padding, h = i.boundary, d = i.rootBoundary, u = i.altBoundary, f = i.flipVariations, p = void 0 === f || f, m = i.allowedAutoPlacements, g = e.options.placement, _ = gt(g), b = l || (_ !== g && p ? (function (t) { if (gt(t) === 'auto') return []; const e = Wt(t); return [zt(t), e, zt(e)] }(g)) : [Wt(g)]), v = [g].concat(b).reduce((t, i) => t.concat(gt(i) === 'auto'
            ? Zt(e, {
    ...
    fn (t) {
      const e = t.state; const i = t.options; const n = t.name; const s = i.mainAxis; const o = void 0 === s || s; const r = i.altAxis; const a = void 0 !== r && r; const l = i.boundary; const c = i.rootBoundary; const h = i.altBoundary; const d = i.padding; const u = i.tether; const f = void 0 === u || u; const p = i.tetherOffset; const m = void 0 === p ? 0 : p; const g = Gt(e, {
        ...
        if (o || a) {
          const k = y === 'y' ? it : ot; const L = y === 'y' ? nt : st; const x = y === 'y' ? 'height' : 'width'; const D = E[y]; const S = E[y] + g[k]; const I = E[y] - g[L]; const N = f ? -T[x] / 2 : 0; const j = b === 'start' ? A[x] : T[x]; const M = b === 'start' ? -T[x] : -A[x]; const P = e.elements.arrow; const H = f && P ? bt(P) : { width: 0, height: 0 }; const R = e.modifiersData['arrow#persistent']
